...
/**
 * Light 主题继续保留 editorial / paper 工作台语义，但本轮向更中性的
 * Porcelain Console 收紧，避免大面积暖黄背景把界面带回“羊皮纸后台”。
 */
export const lightPalette: ThemePalette = {
  ...
  accentColor: '#8e7255',
  accentSoft: 'rgba(142, 114, 85, 0.075)',
  successColor: '#4c765c',
  warningColor: '#986d34',
  dangerColor: '#a55f66',
  contentBg: '#f4f6f8',
  contentBgSecondary: '#eceff3',
  paperBg: '#fcfdff',
  paperBgStrong: '#f7f9fc',
  panelBg: 'rgba(252, 253, 255, 0.92)',
  panelBorder: 'rgba(88, 99, 118, 0.12)',
  frameDivider: 'rgba(88, 99, 118, 0.08)',
  frameDividerStrong: 'rgba(88, 99, 118, 0.14)',
  frameSurfaceSubtle: 'rgba(88, 99, 118, 0.024)',
  frameSurfaceElevated: 'rgba(88, 99, 118, 0.05)',
  textPrimary: '#222a35',
  textSecondary: '#5b6678',
  textTertiary: '#828ea3',
  textOnDark: '#222a35',
  textOnDarkSecondary: '#5b6678',
  sidebarBg: '#f1f4f7',
  sidebarSurface: 'rgba(88, 99, 118, 0.04)',
  sidebarText: '#222a35',
  sidebarTextSecondary: '#606b7d',
  sidebarHoverBg: 'rgba(83, 100, 178, 0.045)',
  sidebarActiveBg: 'linear-gradient(135deg, rgba(83, 100, 178, 0.06), rgba(126, 139, 196, 0.1))',
  sidebarActiveText: '#28304c',
  sidebarBorder: 'rgba(88, 99, 118, 0.1)',
  userBubbleBg: 'linear-gradient(135deg, #e5ebfb 0%, #dde4f8 100%)',
  userBubbleText: '#28304c',
  assistantBubbleBg: 'rgba(255, 255, 255, 0.8)',
  assistantBubbleBorder: 'rgba(88, 99, 118, 0.1)',
  assistantBubbleShadow: 'none',
  cardBlueBg: '#f0f3fc',
  ...
  cardYellowBg: '#f5f1e8',
  cardYellowBorder: '#d8cdb9',
  cardRedBg: '#faeef0',
  cardRedBorder: '#ddc3c8',
  cardGreyBg: '#f2f4f6',
  cardGreyBorder: '#d5dbe4',
  shadowSm: '0 6px 18px rgba(28, 36, 50, 0.04)',
  shadowMd: '0 10px 28px rgba(28, 36, 50, 0.055)',
  shadowLg: '0 18px 42px rgba(28, 36, 50, 0.075)',
  shadowFloat: '0 24px 52px rgba(28, 36, 50, 0.09)',
  appBackground:
    'radial-gradient(circle at top left, rgba(83, 100, 178, 0.055), transparent 24%), linear-gradient(180deg, #fafbfd 0%, #f4f6f8 42%, #eceff3 100%)',
  appGridPrimary: 'rgba(88, 99, 118, 0.04)',
  appGridSecondary: 'rgba(88, 99, 118, 0.026)',
  appGridMask: 'linear-gradient(180deg, rgba(255, 255, 255, 0.34), transparent 88%)',
  selectionBg: 'rgba(83, 100, 178, 0.16)',
  selectionText: '#1f2430',
  scrollThumb: 'rgba(88, 99, 118, 0.16)',
  scrollThumbHover: 'rgba(88, 99, 118, 0.24)',
  sidebarScrollThumb: 'rgba(88, 99, 118, 0.14)',
  sidebarScrollThumbHover: 'rgba(88, 99, 118, 0.22)',
  ...
  buttonDefaultBorder: 'rgba(88, 99, 118, 0.12)',
  buttonDefaultBg: 'rgba(255, 255, 255, 0.78)',
  buttonDefaultHoverBorder: 'rgba(88, 99, 118, 0.18)',
  buttonDefaultHoverBg: 'rgba(255, 255, 255, 0.94)',
  buttonDefaultActiveBorder: 'rgba(88, 99, 118, 0.22)',
  buttonDefaultActiveBg: 'rgba(243, 246, 250, 0.98)',
  buttonTextHoverBg: 'rgba(88, 99, 118, 0.045)',
  buttonTextActiveBg: 'rgba(88, 99, 118, 0.08)',
  buttonDisabledText: 'rgba(91, 102, 120, 0.44)',
  buttonDisabledBorder: 'rgba(88, 99, 118, 0.08)',
  buttonDisabledBg: 'rgba(88, 99, 118, 0.04)',
  ...
  controlBg: 'rgba(255, 255, 255, 0.84)',
  controlBorder: 'rgba(88, 99, 118, 0.12)',
  controlBorderHover: 'rgba(88, 99, 118, 0.18)',
  ...
  surfaceFloating: 'rgba(252, 253, 255, 0.95)',
  surfaceFloatingStrong: 'rgba(252, 253, 255, 0.99)',
  toolbarBg: 'rgba(244, 247, 251, 0.86)',
  toolbarButtonBg: 'rgba(255, 255, 255, 0.82)',
  toolbarButtonHoverBg: 'rgba(255, 255, 255, 0.96)',
  overlayCanvas: 'rgba(255, 255, 255, 0.58)',
  overlayCanvasStrong: 'rgba(249, 251, 253, 0.94)',
  tableHeaderBg: 'rgba(83, 100, 178, 0.06)',
  tableRowBg: 'rgba(255, 255, 255, 0.82)',
  tableRowAltBg: 'rgba(245, 247, 250, 0.86)',
  tableRowHoverBg: 'rgba(83, 100, 178, 0.075)',
  tableCellBorder: 'rgba(88, 99, 118, 0.1)',
  ...
  blockquoteBorder: 'rgba(142, 114, 85, 0.28)',
  cardToneBg: 'rgba(88, 99, 118, 0.05)',
  cardToneText: '#7f664c',
  sessionItemBorder: 'rgba(88, 99, 118, 0.07)',
  sessionItemHoverBorder: 'rgba(88, 99, 118, 0.12)',
  sessionItemIconBg: 'rgba(88, 99, 118, 0.07)',
  sessionItemMenuHoverBg: 'rgba(88, 99, 118, 0.08)',
  sessionRenameBg: 'rgba(255, 255, 255, 0.94)',
  sessionRenameBorder: 'rgba(88, 99, 118, 0.14)',
  sessionRenameFocus: '0 0 0 2px rgba(83, 100, 178, 0.14)',
  sessionActiveMetaText: 'rgba(48, 57, 85, 0.72)',
  visualizeShellBg: '#eef2f6',
  visualizeToolbarText: '#232a35',
  visualizeToolbarButtonBg: 'rgba(255, 255, 255, 0.84)',
  visualizeToolbarButtonBorder: 'rgba(88, 99, 118, 0.12)',
  visualizeToolbarButtonHoverBg: 'rgba(255, 255, 255, 0.96)',
  visualizeToolbarPrimaryBg: 'rgba(252, 253, 255, 0.92)',
  visualizeToolbarPrimaryBorder: 'rgba(88, 99, 118, 0.12)',
  visualizeToolbarPrimaryHoverBg: 'rgba(255, 255, 255, 0.98)',
  visualizeFrameBg: '#ffffff',
  emptySurfaceBg: 'rgba(252, 253, 255, 0.96)',
  emptySurfaceBorder: 'rgba(88, 99, 118, 0.12)',
  emptySurfaceShadow: '0 10px 28px rgba(28, 36, 50, 0.055)',
